...
const phoneticRadicalDatabase =
{
    "化": {
        ...
        "月": {
            ...
            notes: {
                isContainedIn: "月＋龹（トウ）、左(top)月(bottom)（ダ）",
                containsRadical: null,
                similarTo: null
            }
        },
    ...
    "翏": {
        ...
        derivedKanji: {
            ...
            exception: [
                { kanji: "摎", reading: "ク or キュウ" },
                { kanji: "樛", reading: "キュウ" }
            ],
            doublereading: [
               { kanji: "繆", reading: "ビュウ or キュウ or ボク" },
    ...
    "米": {
        ...
        notes: {
            isContainedIn: "婁 or 娄（ロウ）、粦（リン）、粲（サン）、粛（ショウ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "エ": {
        ...
        notes: {
            isContainedIn: "左（サ）、差（サ）、式（シキ）、筑（チク）、尋（ジン）、左(top)月(bottom)（ダ）、巠（ケイ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "豆": {
        ...
        notes: {
            isContainedIn: "口（コウ）、喜without口（キ）、豈（ガイ）、壱 or 壹（イチ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "白": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "邈", reading: "バク" },
                { kanji: "藐", reading: "バク" },
                { kanji: "皃", reading: "ボウ or バク" },
                { kanji: "袙", reading: "バツ or ハ" },
                { kanji: "栢", reading: "ハク or ヒャク" },
                { kanji: "弼", reading: "ヒツ" }
        ...
        notes: {
            isContainedIn: "泉（セン）、習（シュウ）、夏（カ）、宿（シュク）、㣎（ボク）",
    ...
    "日": {
        ...
        notes: {
            isContainedIn: "白（ハク）、泉（セン）、習（シュウ）、㬎 or 显（シツ）、卓（トウ）、並（フ）、晋 or 晉（シン）、春（シュン）、香（コウ）、魯（ロ）、龺（カン）、朝（チョウ）、沓（トウ）",
            containsRadical: null,
            similarTo: "臼（キュウ）"
        }
    },
...
"令": {
    ...
    "共": {
        ...
        notes: {
            isContainedIn: "寒 without⺀（カン）、展（テン）、巽（セン）、異（イ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "禾": {
        ...
        notes: {
            isContainedIn: "季（キ）、囷（キン）、稣（ソ）、香（コウ）、利（リ）、秀（シュウ）、委（イ）、秋（シュウ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "心": {
        ...
        notes: {
            isContainedIn: "舌(top left)心(bottom)（ケイ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "雨": {
        ...
        notes: {
            isContainedIn: "雨(up)一(bottom) or 霝（レイ）、霍（カク）、需（ジュ）",
            containsRadical: null,
            similarTo: "爾（ジ）"
        }
    },
    ...
    "小": {
        ...
        notes: {
            isContainedIn: "小(top)貝(bottom)（サ）、㣎（ボク）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "豕": {
        ...
        notes: {
            isContainedIn: "㒸（タイ）、遂（スイ）、蒙（モウ）、彖 or 彐[top]豕[bottom]（エン）",
            containsRadical: null,
            similarTo: null
        }
    },
...
"黄": {
    ...
    "舌(top left)心(bottom)": {
            ...
            notes: {
                isContainedIn: null,
                containsRadical: "口（コウ）、心（シン）、舌（カツ）",
                similarTo: null
            }
        },
    "舌": {
    ...
    "大": {
        ...
        notes: {
            isContainedIn: "犬（ケン）、天（テン）、因（イン）、伏（フク）、夬（ケツ）、戻（レイ）、奈（ナ）、夭（ヨウ）、夹（キョウ）、奇（キ）、然（ネン）、奐（カン）、莫（ボ or マク）、𦰩（ナン）、奞（フン）、遷（セン）、尞（リョウ）、喬（キョウ）、夸（コ）、夲（ホン）",
            containsRadical: null,
            similarTo: null
        }
    },
...
"堯": {
    ...
    derivedKanji: {
        ...
        modified: [
            ...
            { kanji: "蕘", reading: "ジョウ" },
            { kanji: "繞", reading: "ニョウ" },
            { kanji: "遶", reading: "ニョウ or ジョウ" },
            { kanji: "磽", reading: "コウ or キョウ" }
        ],
        exception: [
            { kanji: "鐃", reading: "ドウ or ニョウ" },
            { kanji: "撓", reading: "トウ" },
            { kanji: "橈", reading: "トウ" }
        ],
        doublereading: [
    ...
    "口": {
        ...
        notes: {
            isContainedIn: "中（チュウ）、石（セキ）、 兄（キョウ）、古（コ）、台（タイ）、加（カ）、史（シ）、司（シ）、可（カ）、句（ク）、召（ショウ）、只（シ）、名（メイ）、冋（カイ）、合（ゴウ）、西（セイ）、同（ドウ）、各（カク）、舌（カツ）、吉（キツ）、足（ソク）、谷（ヨク）、君（グン）、告（コク）、別（ベツ）、亜 or 亞（ア）、呉（ゴ）、呈（テイ）、串（カン）、呂（リョ）、京（ケイ）、知（チ）、占（テン）、周（シュウ or チョウ）、居（キョ）、舎（シャ）、㕣（エン）、尚（ショウ）、品（ヒン）、呆（ホウ）、員（イン）、咅（バイ）、害（カツ）、倉（ソウ）、唐（トウ）、畐（フク）、奇（キ）、敬（ケイ）、執（シ）、亟（キョク）、叧（カイ）、舌(top left)心(bottom)（ケイ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "左": {
        ...
        notes: {
            isContainedIn: "左(top)月(bottom)（ダ）",
    ...
    "㣎": {
        ...
        notes: {
            isContainedIn: null,
            containsRadical: "白（シロ）、小（ショウ）、三（サン）",
            similarTo: null
        }
    },
    "宿": {
    ...
    "寸": {
        ...
        notes: {
            isContainedIn: "将 or 將（ショウ）、寺（ジ）、尃（ハク）、尋（ジン）、寿（チュウ）、爵（シャク）、辱（ジョク）、封（ホウ）、寽（ラチ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "也": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "也", reading: "シ or セ" },
                { kanji: "絁", reading: "シ or セ" },
                { kanji: "匜", reading: "イ" }
            ],
            exception: [
                { kanji: "他", reading: "タ" },
    ...
    "敝": {
        ...
        derivedKanji: {
            ...
            modified: [
                { kanji: "瞥", reading: "ベツ" },
                { kanji: "暼", reading: "ヘツ or ヘチ" },
                { kanji: "鼈", reading: "ベツ or ヘツ" }
            ],
            exception: [],
            doublereading: []
        },
    ...
    "辟": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "檗", reading: "ハク or ビャク" },
                { kanji: "蘗", reading: "ハク or ビャク" },

            ],
            exception: [],
            doublereading: [
            { kanji: "擘", reading: "ハク or ヒャク" },
            { kanji: "甓", reading: "ビャク" },
            { kanji: "闢", reading: "ビャク" },
            { kanji: "襞", reading: "ヒャク" },
            { kanji: "霹", reading: "ヒャク" },
    ...
    "楽": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "爍", reading: "シャク" },
                { kanji: "鑠", reading: "シャク" },
                { kanji: "檪", reading: "レキ or ヤク or ロウ" },
                { kanji: "擽", reading: "リャク or ラク" },
                { kanji: "藥", reading: "ヤク" }
    ...
    "斤": {
        ...
        notes: {
            isContainedIn: "斥（ソ）、折（セツ）、析（セキ）、兵（ヘイ）",
            containsRadical: null,
            similarTo: null
        }
    },
"兵": {
    ...
    "林": {
        ...
        notes: {
            isContainedIn: "禁（キン）、麻（マ）、 厂(out)林(in)（レキ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "翟": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "濯", reading: "タク" },
                { kanji: "戳", reading: "タク" },
                { kanji: "櫂", reading: "タク or トウ" },
                { kanji: "耀", reading: "ヨウ" }
            ],
            exception: [
                { kanji: "擢", reading: "テキ" },
                { kanji: "糴", reading: "チョウ or テキ" }
    ...
    "去": {
        ...
        derivedKanji: {
            ...
            modified: [
                ...
                { kanji: "怯", reading: "キョウ" },
                { kanji: "劫", reading: "コウ or ゴウ or キョウ" },
                { kanji: "刧", reading: "コウ or ゴウ or キョウ" }
            ],
            exception: [
                { kanji: "法", reading: "ホウ" },
                { kanji: "琺", reading: "ホウ" }
    ...
    "殳": {
        ...
        derivedKanji: {
            ...
            exception: [
                ...
                { kanji: "没", reading: "ボツ" },
                { kanji: "疫", reading: "エキ" },
                { kanji: "役", reading: "ヤク or エキ" }
            ],
            doublereading: []
        },
        notes: {
            isContainedIn: "段（ダン）、般（ハン）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "厶": {
        ...
        notes: {
            isContainedIn: "去（キャク）、云（ウン）、会 or 會（カイ）、至（チ）、充（ジュウ）、台（タイ）、𠫓（イク）、公（ショウ）、到（トウ）、屋（アク）、夋（シュン）、㐬（リュウ）、能（ハイ）、鬼（カイ）、公(top)心(bottom)（ソウ）、侌（イン）、育(left)攵(right)（テツ）",
            containsRadical: null,
            similarTo: null
        }
    },
    ...
    "莫": {
            ...
            derivedKanji: {
                regular: [
                    ...
                    { kanji: "膜", reading: "マク" },
                    { kanji: "寞", reading: "バク or マク" },
                    { kanji: "模", reading: "ボ or モ" },
                    { kanji: "糢", reading: "ボ or モ" },
                    { kanji: "謨", reading: "ボ or モ" }
                ],
                modified: [
                    { kanji: "摸", reading: "モ" },
                    { kanji: "莫", reading: "バク" },
                    { kanji: "驀", reading: "バク" },
                    { kanji: "獏", reading: "バク or ミャク" },
                    { kanji: "漠", reading: "バク" },
                    { kanji: "貘", reading: "バク" },
                    { kanji: "蟇", reading: "バ or マ" },
                    { kanji: "蟆", reading: "バ or マ" }
    ],
                exception: [
                    { kanji: "冪", reading: "ベキ" },
                    { kanji: "羃", reading: "ベキ" }
    ...
    "皮": {
        ...
        derivedKanji: {
            regular: [
                ...
                { kanji: "頗", reading: "ハ" },
                { kanji: "簸", reading: "ハ" },
                { kanji: "菠", reading: "ハ or ホ" },
                { kanji: "坡", reading: "ハ or ヒ" },
                { kanji: "跛", reading: "ハ or ヒ" },
                { kanji: "陂", reading: "ヒ or ハ" },
    ...
    "軍": {
        ...
        derivedKanji: {
            ...
            modified: [
                { kanji: "軍", reading: "グン" },
                { kanji: "皹", reading: "クン or キン" },
                { kanji: "皸", reading: "クン or キン" },
],
            exception: [
            ],
            doublereading: []
...
async function displayCurrentKanji() {
    ...
    if (currentInput) {
        ...
        if (!isJapanese) {
            if (!isVocabularyFetched || vocabulary.length === 0) {
            ...
            if (currentInput.length > 1) {
                ...
                navButton.innerText = currentKanjiIndex < currentInput.length - 1 ? '→' : '←';
                navButton.onclick = () => navigateKanji(currentKanjiIndex < currentInput.length - 1 ? 1 : -(currentInput.length - 1));
                if (navContainer) {
            ...
            if (isKana) {
                ...
                if (!onyomiReading && hasPhoneticRadical) {
                    const phoneticRadicalData = phoneticRadicalDatabase[phoneticRadical];
                    if (phoneticRadicalData) {
                        const derivedKanji = [
                            ...(phoneticRadicalData.derivedKanji?.regular || []),
                        ...
                        const kanjiEntry = derivedKanji.find(entry => entry && entry.kanji === kanjiChar);
                        onyomiReading = kanjiEntry?.reading || phoneticRadicalReading || "";
                    } else {
                        onyomiReading = phoneticRadicalReading || "";
                    }
                }
    ...
    document.querySelectorAll('.clickable-kanji').forEach(kanjiSpan => {
        ...
        kanjiSpan.addEventListener('click', handleKanjiClick);
    });
}
...
function navigateKanji(direction) {
    ...
    if (currentKanjiIndex >= currentInput.length) {
        currentKanjiIndex = 0; // Wrap around to the first character
    } else if (currentKanjiIndex < 0) {
        currentKanjiIndex = currentInput.length - 1; // Wrap around to the last character
    }
    displayCurrentKanji();
}
...
let touchStartX = 0;
let touchEndX = 0;
const kanjiBoxSection = document.getElementById('kanjiBoxSection');
if (kanjiBoxSection) {
...
async function updateVocabDisplay(input) {
    ...
    // 4. Clear vocabBox only when rendering new content
    vocabBox.innerHTML = '';
    ...
    // 5. Filter Vocabulary Based on Input
    let filteredVocab = [];
    if (isJapanese) {
