const phoneticRadicalDatabase = 
    {
        ...
        "及 or 刍": {
            ...
            "エ": {
                ...
                notes: {
                    isContainedIn: "左（サ）、差（サ）、式（シキ）、筑（チク）",
                    containsRadical: null,
                    similarTo: null
                }
            },
            ...
            "麻": {
                ...
                notes: {
                    isContainedIn: null,
                    containsRadical: "林（リン）",
                    similarTo: "厂(out)林(in)（レキ）"
                }
            },
            "俞": {
                defaultReading: "ユ",
            ...
            "凶": {
                ...
                notes: {
                    isContainedIn: "彡(top)凶(bottom)（ノウ）",
                    containsRadical: null,
                    similarTo: "区（ク）"
                }
            }, 
            ...
            "也 or 它": {
                ...
                derivedKanji: {
                    ...
                    modified: [
                        { kanji: "施", reading: "シ or セイ" }
                    ],
                    exception: [
                        { kanji: "他", reading: "タ" },
                        { kanji: "蛇", reading: "ダ or ジャ" }
                    ],
                    doublereading: []
                },
                notes: {
            ...
            "林": {
                ...
                notes: {
                    isContainedIn: "麻（マ）and 厂(out)林(in)（レキ）",
                    containsRadical: null,
                    similarTo: null
                }
            },
...
const meaningRadicalDatabase = {
                "氵": {
                    radical: "water",
                    kanjiList: ["汁", "氾", "汚", "汗", "江", "池", "汎", "汽", "決", "沙", "汰", "沢", "沖", "沈", "没", "沃", "泳", "沿", "河", "泣", "況", "治", "沼", "注", "泥", "波", "泊", "泌", "沸", "法", "泡", "油", "海", "活", "洪", "浄", "津", "浅", "洗", "洞", "派", "洋", "浦", "消", "浸", "浜", "浮", "浴", "流", "涙", "浪", "淫", "液", "涯", "渇", "渓", "混", "済", "渋", "淑", "渉", "深", "清", "淡", "添", "涼", "温", "渦", "減", "湖", "港", "滋", "湿", "測", "渡", "湯", "満", "湧", "湾", "滑", "漢", "源", "溝", "準", "滞", "滝", "溺", "漠", "滅", "溶", "演", "漁", "漆", "漸", "漬", "滴", "漂", "漫", "漏", "潰", "潟", "潔", "潤", "潜", "潮", "澄", "激", "濁", "濃", "濯", "濫", "瀬"]
                },
                ...
                "糸": {
                    radical: "thread",
                    kanjiList: ["糸", "系", "紀", "級", "糾", "紅", "約", "索", "紙", "純", "素", "納", "紛", "紡", "紋", "経", "紺", "細", "終", "紹", "紳", "組", "累", "絵", "給", "結", "絞", "紫", "絶", "統", "絡", "継", "絹", "続", "維", "網", "緒", "総", "綻", "綿", "綱", "緑", "練", "縁", "緩", "緊", "縄", "線", "締", "編", "緯", "縦", "緻", "縛", "繁", "縫", "縮", "績", "繊", "繭", "織", "繕", "繰"]
                },
                ...
                "亻": {
                    radical: "person",
                    kanjiList: ["仁", "仏", "仕", "仙", "他", "代", "付", "仮", "伎", "休", "仰", "件", "仲", "伝", "任", "伐", "伏", "位", "何", "佐", "作", "伺", "似", "住", "伸", "体", "但", "低", "伯", "伴", "依", "価", "佳", "供", "使", "侍", "侮", "併", "例", "係", "侯", "俊", "信", "侵", "促", "俗", "便", "保", "侶", "俺", "倹", "個", "候", "借", "修", "値", "倒", "俳", "倍", "俵", "傲", "俸", "倫", "偽", "偶", "健", "側", "停", "偵", "偏", "偉", "傘", "備", "傍", "僅", "傾", "傑", "倣", "債", "催", "傷", "僧", "働", "像", "僕", "僚", "億", "儀", "儒", "償", "優"]
                },
                "𠆢": {
                    radical: "person",
                    kanjiList: ["介", "今", "令", "会", "企", "全", "余", "舎", "倉", "舗"]
                },
                "手": {
                    radical: "hand",
                    kanjiList: ["手", "承", "挙", "拳", "掌", "撃", "摯", "摩"]
                },
        
                "扌": {
                    radical: "hand",
                    kanjiList: ["才", "打", "払", "扱", "技", "抗", "抄", "折", "択", "投", "把", "抜", "批", "扶", "抑", "押", "拐", "拡", "拒", "拠", "拘", "招", "拙", "拓", "担", "抽", "抵", "拝", "拍", "披", "抱", "抹", "拉", "括", "挟", "拷", "挨", "拶", "指", "持", "拾", "拭", "挑", "挫", "振", "捜", "挿", "捉", "捗", "捕", "掛", "掘", "掲", "控", "採", "捨", "授", "推", "据", "接", "措", "掃", "探", "捻", "排", "描", "握", "援", "換", "揮", "提", "搭", "揚", "揺", "携", "搾", "摂", "損", "搬", "摘", "撮", "撤", "撲", "操", "擁", "擬", "擦"]
        },
        
                "木": {
                    radical: "tree/wood",
                    kanjiList: ["木", "札", "本", "末", "未", "机", "朽", "朱", "朴", "材", "条", "杉", "束", "村", "来", "果", "枝", "松", "枢", "析", "東", "杯", "板", "枚", "枕", "林", "枠", "栄", "架", "柿", "枯", "査", "柵", "柔", "染", "柱", "栃", "柄", "某", "柳", "案", "桜", "格", "核", "株", "桁", "校", "根", "栽", "桟", "栓", "桑", "桃", "梅", "械", "梗", "巣", "梨", "椅", "棺", "棋", "極", "検", "植", "森", "棚", "椎", "棟", "棒", "楷", "楽", "棄", "業", "楼", "概", "構", "模", "様", "横", "権", "槽", "標", "機", "橋", "樹", "欄"]
        },
        
                "心": {
                    radical: "heart/mind",
                    kanjiList: ["心", "必", "応", "志", "忘", "忌", "忍", "念", "忠", "忽", "思", "急", "怨", "怠", "怒", "息", "恩", "恐", "恵", "恣", "恥", "恋", "恕", "悪", "患", "悠", "悉", "悲", "惑", "惹", "惣", "惡", "惠", "意", "感", "想", "愛", "愚", "慈", "愁", "態", "慰", "慶", "憂", "慮", "慧", "憲", "憩", "懇", "應", "懲", "懸"]
                },
        
                "忄": {
                    radical: "heart/mind",
                    kanjiList: ["忙", "快", "性", "怪", "怖", "怜", "悔", "恒", "恨", "恢", "恰", "恆", "情", "悦", "悟", "悩", "悌", "惧", "惨", "惜", "悼", "惟", "惚", "惇", "慌", "惰", "愉", "惺", "慨", "慎", "慄", "愼", "慣", "憎", "慢", "憬", "憧", "憤", "憶", "懐", "憾", "憐", "懷"]
                },
                ...
                "口": {
                    radical: "mouth",
                    kanjiList: ["口", "右", "可", "句", "古", "号", "史", "司", "𠮟", "召", "台", "各", "吉", "吸", "叫", "向", "后", "合", "吐", "同", "名", "吏", "含", "吟", "君", "呉", "告", "吹", "呈", "否", "呂", "呼", "呪", "周", "味", "命", "和", "哀", "咽", "咲", "品", "員", "唄", "唆", "唇", "哲", "唐", "哺", "喝", "啓", "商", "唱", "唾", "問", "唯", "営", "喚", "喜", "喫", "喉", "善", "喪", "喩", "嗅", "嗣", "嘆", "器", "嘱", "嘲", "噴", "嚇"]
                },
        
                "言": {
                    radical: "to say",
                    kanjiList: ["言", "計", "訂", "訃", "記", "訓", "託", "討", "許", "訟", "設", "訪", "訳", "詠", "詐", "詞", "証", "詔", "診", "訴", "評", "該", "詰", "詣", "誇", "詩", "試", "詳", "誠", "詮", "誉", "話", "語", "誤", "誌", "誓", "説", "読", "認", "誘", "謁", "課", "諸", "請", "諾", "誰", "誕", "談", "調", "諭", "諧", "諮", "諦", "謀", "論", "謡", "謹", "謙", "講", "謝", "謄", "謎", "警", "識", "譜", "議", "護", "譲"]
                },
                "辶": {
                    radical: "way",
                    kanjiList: ["込", "辺", "迅", "近", "迎", "返", "述", "迭", "迫", "逆", "送", "退", "追", "逃", "迷", "逝", "造", "速", "逐", "通", "逓", "途", "透", "連", "逸", "週", "進", "逮", "運", "過", "遇", "遂", "達", "遅", "道", "遍", "遊", "違", "遠", "遺", "遡", "遜", "遮", "遭", "適", "遣", "遵", "選", "遷", "還", "避"]
                },
                "土": {
                    radical: "earth",
                    kanjiList: ["土", "圧", "在", "地", "均", "坑", "坂", "坊", "垂", "坪", "垣", "型", "城", "埋", "域", "基", "埼", "執", "堆", "堂", "培", "堀", "堪", "堅", "場", "堕", "塚", "堤", "塔", "塀", "報", "塁", "塩", "塊", "塞", "塑", "塡", "塗", "墓", "境", "塾", "増", "墨", "墜", "墳", "壊", "墾", "壌", "壇", "壁"]
                },
        
                "艹": {
                    radical: "grass",
                    kanjiList: ["芋", "芝", "花", "芸", "芯", "芳", "英", "苛", "芽", "苦", "茎", "若", "苗", "茂", "茨", "荒", "草", "荘", "茶", "荷", "華", "萎", "菓", "菊", "菌", "菜", "著", "葛", "葬", "葉", "落", "蓋", "蒸", "蓄", "蔑", "蔵", "蔽", "薫", "薪", "薦", "薄", "薬", "藤", "藩", "藍", "藻"]
                },
                ...
                "日": {
                    radical: "sun/day",
                    kanjiList: ["日", "旧", "旦", "旨", "旬", "早", "易", "旺", "昆", "昇", "昔", "明", "映", "昨", "春", "昭", "是", "星", "昼", "昧", "時", "暁", "景", "暑", "晶", "晴", "晩", "普", "暗", "暇", "暖", "暮", "暦", "暫", "暴", "曇", "曖", "曜"]
                },
        
                "女": {
                    radical: "woman",
                    kanjiList: ["女", "奴", "好", "如", "妃", "妄", "妥", "妊", "妨", "妙", "妖", "委", "妻", "姉", "始", "姓", "妬", "妹", "威", "姻", "姿", "娯", "娠", "姫", "娘", "婚", "婆", "婦", "媛", "婿", "媒", "嫁", "嫌", "嫉", "嫡", "嬢"]
                },
        
                "宀": {
                    radical: "roof",
                    kanjiList: ["安", "宇", "守", "宅", "完", "宛", "官", "宜", "実", "宗", "宙", "定", "宝", "客", "室", "宣", "宴", "家", "害", "宮", "宰", "宵", "容", "寄", "寂", "宿", "密", "寒", "富", "寛", "寝", "寡", "察", "寧", "審", "寮"]
                },
        
                "貝": {
                    radical: "shell/money",
                    kanjiList: ["貝", "貞", "負", "貢", "財", "貨", "貫", "責", "貪", "販", "貧", "賀", "貴", "貸", "貯", "貼", "買", "費", "貿", "資", "賊", "賃", "賂", "賄", "賛", "賜", "質", "賞", "賠", "賓", "賦", "賢", "賭", "購", "贈"]
                },
        
                "金": {
                    radical: "gold/metal",
                    kanjiList: ["金", "釜", "針", "釣", "鈍", "鉛", "鉱", "鉄", "鉢", "鈴", "銀", "銃", "銭", "銅", "銘", "鋭", "鋳", "錦", "錮", "鋼", "錯", "錠", "錬", "録", "鍵", "鍛", "鍋", "鎌", "鎖", "鎮", "鏡", "鐘", "鑑"]
                },
        
                "刀": {
                    radical: "sword",
                    kanjiList: ["刀", "刃", "刈", "切", "分", "初", "券"]
                },
                ...
                "阝": {
                    radical: "hills",
                    kanjiList: ["降", "険", "阪", "防", "阻", "附", "限", "院", "陥", "降", "除", "陣", "陛", "陰", "険", "陳", "陶", "陪", "陸", "隆", "陵", "階", "隅", "随", "隊", "陽", "隔", "隙", "隠", "際", "障", "隣"]
                },
        
                "火": {
                    radical: "fire",
                    kanjiList: ["火", "灰", "灯", "災", "炎", "炊", "炉", "炭", "焼", "煙", "煩", "燥", "爆"]
                },
        
                "灬": {
                    radical: "ashes",
                    kanjiList: ["為", "点", "烈", "煮", "焦", "然", "無", "照", "煎", "熊", "熟", "熱", "燃"]
                },
        
                "竹": {
                    radical: "bamboo",
                    kanjiList: ["竹", "笑", "第", "笛", "符", "筋", "策", "答", "等", "筒", "筆", "節", "箇", "管", "算", "箋", "箱", "箸", "範", "築", "篤", "簡", "簿", "籍", "籠"]
                },
        
                "力": {
                    radical: "strength",
                    kanjiList: ["力", "加", "功", "劣", "助", "努", "励", "労", "劾", "効", "勅", "勃", "勇", "勉", "勘", "動", "務", "勤", "勝", "募", "勧", "勢", "勲"]
                },
        
                "禾": {
                    radical: "grain",
                    kanjiList: ["私", "秀", "科", "秋", "秒", "称", "租", "秩", "秘", "移", "税", "程", "稚", "穀", "種", "稲", "稼", "稽", "稿", "穂", "穏", "積", "穫"]
                },
        
                "頁": {
                    radical: "head",
                    kanjiList: ["頃", "頂", "項", "順", "須", "頑", "頓", "頒", "預", "領", "頭", "頰", "頼", "頻", "額", "顎", "顔", "顕", "題", "類", "願", "顧"]
                },
        
                "衣": {
                    radical: "clothing",
                    kanjiList: ["衣", "表", "衷", "衰", "袋", "裁", "装", "裂", "裏", "製", "褒", "襲"]
                },
        
                "衤": {
                    radical: "clothing",
                    kanjiList: ["袖", "被", "補", "裕", "褐", "裾", "裸", "複", "襟"]
                },
        
                "目": {
                    radical: "eye",
                    kanjiList: ["目", "直", "盲", "看", "県", "盾", "省", "相", "眉", "冒", "真", "眠", "眼", "眺", "睡", "督", "睦", "瞳", "瞭", "瞬"]
                },
        
                "彳": {
                    radical: "to go",
                    kanjiList: ["役", "往", "径", "征", "彼", "後", "待", "律", "従", "徐", "徒", "得", "御", "循", "復", "微", "徴", "徳", "徹"]
                },
        
                "行": {
                    radical: "to go",
                    kanjiList: ["行", "術", "街", "衡", "衛", "衝"]
                },
        
                "田": {
                    radical: "rice field",
                    kanjiList: ["田", "甲", "申", "由", "男", "町", "画", "畏", "界", "畑", "畝", "畜", "畔", "留", "異", "略", "畳", "番", "畿"]
                },
        
                "巾": {
                    radical: "cloth",
                    kanjiList: ["巾", "市", "布", "帆", "希", "帥", "帝", "帰", "師", "席", "帯", "常", "帳", "幅", "帽", "幕", "幣"]
                },
        
                "广": {
                    radical: "building",
                    kanjiList: ["広", "庁", "序", "床", "底", "店", "府", "度", "庫", "座", "庭", "康", "庶", "庸", "廃", "廊", "廉"]
                },
        
                "攵": {
                    radical: "hand with stick",
                    kanjiList: ["改", "攻", "放", "故", "政", "敏", "救", "教", "敗", "敢", "敬", "散", "数", "敵", "敷", "整", "厳"]
                },
                ...
                "犭": {
                    radical: "beast",
                    kanjiList: ["犯", "状", "狂", "狙", "狭", "狩", "独", "猫", "猛", "猟", "猶", "猿", "獄", "獲"]
                },
                "一": {
                    radical: "one",
                    kanjiList: ["一", "七", "丁", "下", "三", "上", "丈", "万", "与", "不", "且", "丘", "世", "丙", "両", "並"]
                },
        
                "大": {
                    radical: "big",
                    kanjiList: ["大", "太", "天", "夫", "央", "失", "奇", "奈", "奉", "奔", "契", "奏", "奥", "奨", "奪", "奮"]
                },
        
                "山": {
                    radical: "mountain",
                    kanjiList: ["山", "岐", "岡", "岳", "岩", "岸", "岬", "峡", "峠", "島", "峰", "崖", "崎", "崇", "崩", "嵐"]
                },
        
                "石": {
                    radical: "stone",
                    kanjiList: ["石", "研", "砂", "砕", "破", "砲", "硬", "硝", "硫", "碁", "磁", "碑", "確", "磨", "礁", "礎"]
                },
        
                "尸": {
                    radical: "corpse",
                    kanjiList: ["尺", "尻", "尼", "尽", "局", "尿", "尾", "居", "屈", "届", "屋", "展", "属", "層", "履"]
                },
        
                "⺩": {
                    radical: "king",
                    kanjiList: ["玩", "珍", "珠", "班", "球", "現", "理", "琴", "瑠", "璃", "環"]
                },
                ...
                "疒": {
                    ...
                    kanjiList: ["疫", "疾", "症", "疲", "病", "痕", "痩", "痛", "痘", "痢", "痴", "瘍", "療", "癖", "癒"]
                },
                ...
                "礻": {
                    radical: "spirit",
                    kanjiList: ["礼", "社", "祈", "祉", "祝", "神", "祖", "祭", "祥", "禍", "禅", "福"]
                },
        
                "車": {
                    radical: "car/cart",
                    kanjiList: ["車", "軌", "軍", "軒", "転", "軟", "軽", "軸", "較", "載", "輝", "輩", "輪", "輸", "轄"]
                },
        
                "酉": {
                    radical: "barrel",
                    kanjiList: ["酌", "酒", "酎", "配", "酔", "酢", "酬", "酪", "酵", "酷", "酸", "醒", "醜", "醸"]
                },
        
                "雨": {
                    radical: "rain",
                    kanjiList: ["雨", "雪", "雲", "雰", "電", "雷", "零", "需", "震", "霊", "霜", "霧", "露"]
                },
        
                "十": {
                    radical: "ten",
                    kanjiList: ["十", "千", "午", "升", "半", "協", "卒", "卓", "単", "南", "卑", "博"]
                },
        
                "囗": {
                    radical: "enclosure",
                    kanjiList: ["四", "囚", "因", "回", "団", "囲", "困", "図", "固", "国", "圏", "園"]
                },
                ...
                "儿": {
                    radical: "person's legs",
                    kanjiList: ["元", "兄", "光", "充", "先", "兆", "克", "児", "売", "免", "党"]
                },
        
                "弓": {
                    radical: "bow",
                    kanjiList: ["弓", "引", "弔", "弟", "弦", "弥", "弧", "弱", "強", "張", "弾"]
                },
                ...
                "𧾷": {
                    radical: "foot",
                    kanjiList: ["距", "跡", "践", "跳", "路", "踊", "踪", "踏", "蹴", "躍"]
                },
        
                "門": {
                    radical: "door",
                    kanjiList: ["門", "閉", "開", "間", "閑", "閣", "関", "閥", "閲", "闇", "闘"]
                },
        
                "馬": {
                    radical: "horse",
                    kanjiList: ["馬", "駅", "駆", "駄", "駒", "駐", "騎", "験", "騒", "騰", "驚"]
                },
        
                "穴": {
                    radical: "hole",
                    kanjiList: ["穴", "究", "空", "突", "窃", "窓", "窒", "窟", "窮", "窯"]
                },
        
                "米": {
                    radical: "rice",
                    kanjiList: ["米", "粋", "粉", "粗", "粘", "粒", "粧", "精", "糖", "糧"]
                },
        
                "虫": {
                    radical: "bug",
                    kanjiList: ["虫", "虹", "蚊", "蚕", "蛍", "蛇", "蛮", "蜂", "蜜", "融"]
                },
        
                "又": {
                    radical: "hand doing sth",
                    kanjiList: ["又", "収", "双", "反", "友", "取", "受", "叔", "叙"]
                },
        
                "子": {
                    radical: "child",
                    kanjiList: ["子", "孔", "字", "存", "孝", "学", "季", "孤", "孫"]
                },
        
                "隹": {
                    radical: "wing",
                    kanjiList: ["隻", "雇", "集", "雄", "雅", "雑", "雌", "難", "離"]
                },
                ...
                "欠": {
                    ...
                    kanjiList: ["欠", "次", "欧", "欲", "款", "欺", "歌", "歓"]
                },
                "皿": {
                    radical: "plate",
                    kanjiList: ["皿", "盆", "益", "盛", "盗", "盟", "監", "盤"]
                },
        
                "舟": {
                    radical: "boat",
                    kanjiList: ["舟", "航", "般", "舷", "船", "舶", "艇", "艦"]
                },
        
                "戈": {
                    radical: "pike",
                    kanjiList: ["成", "我", "戒", "戚", "戦", "戯", "戴"]
                },
        
                "曰": {
                    radical: "words",
                    kanjiList: ["曲", "更", "書", "曽", "曹", "最", "替"]
                },
        
                "罒": {
                    radical: "net",
                    kanjiList: ["罪", "署", "置", "罰", "罵", "罷", "羅"]
                },
                ...
                "戸": {
                    radical: "door",
                    kanjiList: ["戸", "戻", "所", "房", "扇", "扉"]
                },
        
                "方": {
                    radical: "flag/direction",
                    kanjiList: ["方", "施", "旅", "旋", "族", "旗"]
                },
        
                "止": {
                    radical: "to stop/foot",
                    kanjiList: ["止", "正", "武", "歩", "歳", "歴"]
                },
        
                "殳": {
                    radical: "hand with pike",
                    kanjiList: ["殴", "段", "殺", "殻", "毀", "殿"]
                },
                ...
                "羽": {
                    ...
                    kanjiList: ["羽", "翁", "習", "翌", "翼", "翻"]
                },
        
                "走": {
                    radical: "to run",
                    kanjiList: ["走", "赴", "起", "越", "超", "趣"]
                },
...
function checkKanjiReadingGroup(kanji) {
    for (const [radical, radicalData] of Object.entries(phoneticRadicalDatabase)) {
        ...
        if (foundRegular.length > 0) {
            ...
            updateReadingBoxes(readings, radical, radicalData.defaultReading);
        ...
        if (foundModified) {
            updateReadingBoxes(foundModified.reading, radical, radicalData.defaultReading);
        ...
        if (foundException) {
            updateReadingBoxes(foundException.reading, radical, radicalData.defaultReading);
        ...
        if (foundDoubleReading) {
            updateReadingBoxes(foundDoubleReading.reading, radical, radicalData.defaultReading);
            return formatOutput(kanji, foundDoubleReading.reading, radical, radicalData.defaultReading, "doublereading", radicalData.notes);
        }
    }

    return `The kanji ${kanji} does not contain a phonetic radical.\n`;
}

const kanjiInput = document.getElementById('kanjiInput');
const meaningRadicalBox = document.getElementById('meaningradical-box');
...
function checkMeaningRadical(kanji) {
    let foundRadical = false;

    for (const [radical, data] of Object.entries(meaningRadicalDatabase)) {
        if (data.kanjiList.includes(kanji)) {
            updateMeaningRadicalBox(data.radical, radical); // Use the correct parameters
            foundRadical = true;
            break; // Break once the radical is found
        }
    }
...
function updateReadingBoxes(onyomiReading, radical, radicalReading, kunyomiReading) {
    ...
    // Ensure we are only updating the intended elements
    if (onyomiBoxElement) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function processKanjiInput(inputKanji = null) {
        const kanji = inputKanji || document.getElementById("kanjiInput").value.trim();
        const displayKanjiElement = document.getElementById("displayKanji");
        const levelBubbleElement = document.getElementById("levelBubble");
    ...
    if (checkButton) {
        checkButton.addEventListener("click", function() {
            processKanjiInput(); // Call function without parameters to use input value
        });
    } else {
        console.error("Element with ID 'checkButton' not found!");
    }

    const randomButton = document.getElementById("randomButton");
    if (randomButton) {
        randomButton.addEventListener("click", function() {
            const randomKanji = getRandomKanji(); // Assume you have a function to get a random kanji
            processKanjiInput(randomKanji); // Call function with the random kanji
        });
    } else {
        console.error("Element with ID 'randomButton' not found!");
    }

    const kanjiInputElement = document.getElementById("kanjiInput");
    if (kanjiInputElement) {
        kanjiInputElement.addEventListener("keydown", function(event) {
            if (event.key === "Enter" && !event.isComposing) {
                processKanjiInput(); // Call function without parameters to use input value
            }
        });

        kanjiInputElement.addEventListener("compositionend", function(event) {
            // Mark the composition as finished
            event.target.isComposing = false;
        });

        kanjiInputElement.addEventListener("compositionstart", function(event) {
            // Mark the composition as started
            event.target.isComposing = true;
        });
    } else {
        console.error("Element with ID 'kanjiInput' not found!");
    }

    updateMobileBoxes(); // Ensure this function is called to update elements
});
...
function updateMobileBoxes() {
    ...
    // Sync Kun'yomi box
    mobileKunyomiBoxElement.innerHTML = "<span style='font-size:0.5em;'>Kun'yomi // </span><strong>" + kunyomiBoxElement.textContent + "</strong>";

    // Sync English Meaning box
    mobileEnglishBoxElement.innerHTML = englishBoxElement.innerHTML;

    // Sync On'yomi box
    mobileOnyomiBoxElement.innerHTML = "<span style='font-size:0.5em;'>On'yomi // </span><strong>" + onyomiBoxElement.textContent + "</strong>";

    // Sync Meaning Radical box
    mobileMeaningRadicalBoxElement.innerHTML = "<span style='font-size:0.5em;'>Meaning Radical // </span><strong>" + meaningRadicalBoxElement.textContent + "</strong>";
...
console.log("Readings array at the start of processKanjiInput:", readings);
...
function getJLPTLevel(kanji) {
    ...
    const kanjiDatabase = {
        ...
        N5: ["日", "月", "火", "水", "木", "金", "土", "大", "中", "小", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "百", "千", "万", "上", "下", "東", "西", "南", "北", "人", "今", "休", "何", "先", "入", "円", "出", "分", "前", "午", "半", "友", "右", "名", "国", "外", "天", "女", "子", "学", "山", "川", "左", "年", "後", "時", "書", "本", "来", "校", "母", "毎", "気", "父", "生", "男", "白", "聞", "行", "見", "話", "語", "読", "車", "長", "間", "雨", "電", "食", "高"]
    };

    for (const [level, kanjiList] of Object.entries(kanjiDatabase)) {
...
function syncContent(sourceId, targetId, prefix = "") {
    const sourceElement = document.getElementById(sourceId);
    const targetElement = document.getElementById(targetId);

    if (sourceElement && targetElement) {
        targetElement.innerHTML = prefix + sourceElement.innerHTML;
    }
}

// Use the generic function
syncContent("displayKanji", "mobile-displayKanji");
syncContent("english-box", "mobile-english-box", "English Meaning // ");
syncContent("kunyomi-box", "mobile-kunyomi-box", "Kun'yomi // ");
syncContent("meaningradical-box", "mobile-meaningradical-box", "Meaning Radical // ");
syncContent("onyomi-box", "mobile-onyomi-box", "On'yomi // ");
syncContent("radical-box", "mobile-radical-box", "Phonetic Radical // ");
